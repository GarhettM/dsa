...
const toTitleCase = (arr) => arr.map(curr => curr.replace(curr[0], curr[0].toUpperCase()))
  // Solution code here...
...
let biggerThanLuke = (arr) => {
  ...
  let x = '';
  arr.forEach(val => {
    const a = parseInt(val.mass)
    const b = parseInt(arr[0].mass)
