...
const validatePin = (pin) => {
  // const str = 'car';
  const regex = /^\d{4}$/g;
  // const matches = str.match(regex); This will be an array of matches within a var called string.
  // const test = regex.test(str) this will return true or false statements if it finds a match or not
...
const validateEmail = (email) => {
  // Solution code here...
  const regex = /^[A-Za-z0-9]+\.?[A-Za-z0-9]+@[A-Z-a-z0-9]+\.(net|com|org)$/;
