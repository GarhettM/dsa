...
const createServer = () => {
  ...
  app.get('/aboutme', (req,res) => {
    res.send('I\'m tall and live in Seattle. I just started paddleboarding on lake union but since I\'m so out of shape my entire torso is on fire after just 30 minutes out on the lake.')
  });

  app.get('/favoritefoods', (req, res) => {
    res.send(['Cereal', 'Ham Sandwich', 'Steak'])
  })
